...
class AddImagesChaletScreen extends StatefulWidget {
  // AddImagesChaletScreen({Key? key}) : super(key: key);
  late bool isEdit;
  late int? lenghtList;

  AddImagesChaletScreen({this.isEdit = false, this.lenghtList});

  @override
  State<AddImagesChaletScreen> createState() => _AddImagesChaletScreenState();
}

class _AddImagesChaletScreenState extends State<AddImagesChaletScreen>
    with Helpers {
  ...
  Widget build(BuildContext context) {
    context.settingsStatusBarInScreen(isDark: false);
    return Scaffold(body: GetX<CreateChaletGetxController>(
      ...
      return WillPopScope(
        ...
        child: Stack(
          children: [
                      ...
                      children: [
                        GestureDetector(
                            onLongPress: () {
                              ...
                              // if (controller.loadingPickedImages.isFalse) {
                            ...
                            onTap: () {
                              ...
                              // if (controller.loadingPickedImages.isFalse) {
                                if (controller.isAllowSelect.value) {
                                  if (controller.selectedImageFiles
                                      .contains(controller.imageFiles[0])) {
                                    controller.selectedImageFiles
                                        .remove(controller.imageFiles[0]);
                                    ...
                                    controller.selectedImageFiles
                                        .add(controller.imageFiles[0]);
                                    controller.firstImageIsSelected.value = true;
                                  }
                                } else {
                                  controller.imageFiles.isEmpty
                                      ? _pickImage()
                                      : GoViewOicturesScreen();
                                }
                            //  }

                            },
                            child:
                            // controller.loadingPickedImages.isFalse
                            //     ?
                            Container(
                                    height: 290.h,
                                    width: double.infinity,
                                ...
                                //       // child: SizedBox(
                                //       //   height: double.infinity,
                                //       //   child: ShimmerLoadingWidget(height: double.infinity, width: double.infinity,)
                                //       // )
                                //     ),
                                //   )
          ),
                        Visibility(
                          ...
                          child: PositionedDirectional(
                            ...
                            top: 10.w,
                            child: Container(
                              height: controller.selectedImageFiles.contains(
                                  controller.imageFiles[0])
                                  ? null
                                  : 20,
                              width: controller.selectedImageFiles.contains(
                                  controller.imageFiles[0])
                                  ? null
                                  : 20,
                              ...
                              child: controller.selectedImageFiles.contains(
                                  controller.imageFiles[0])
                                  ? Icon(
                                Icons.check_circle,
                                color: primaryColor,
            ...
            Container(
              margin: EdgeInsets.only(top: 400.7.h, right: 20.w, left: 20.w),
              child:
              //controller.loadingPickedImages.value  ?
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                    ...
                    if (controller.imageFiles.value.isNotEmpty || controller.loadingPickedImages.isTrue) {
                      if(index < controller.imageFiles.value.length ){
                        if (index == controller.imageFiles.value.length - 1) {
                          ...
                          return Stack(children: [
                            GestureDetector(
                              onLongPress: () {
                                ...
                                controller.selectedImageFiles
                                    .add(controller.imageFiles[index + 1]);
                                controller.isAllowSelect.value = true;
                              },
                              onTap: () {
                                if (controller.isAllowSelect.value) {
                                  ...
                                  if (controller.selectedImageFiles
                                    ...
                                    controller.selectedImageFiles
                                        .remove(controller.imageFiles[index + 1]);
                                  ...
                                  Get.to(() =>
                                      ViewPicturesForAdminScreen(
                                          firstIndex: index + 1,
                                          imagesChalet: controller.imageFiles
                                              .value));
                                }
                              },
                              /*
                     ...
                     if( controller.selectedImageFiles.contains(0)){
                      ...
                      controller.imageFiles.isEmpty ? _pickImage() : null;
                           ...
                           */
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(16),
                                child: controller.loadingPickedImages.isTrue ? ShimmerLoadingWidget(height: double.infinity, width:  double.infinity):Image.file(
                                  controller.imageFiles.value[index + 1],
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                        ...
                        return ShimmerLoadingWidget(height: double.infinity, width: double.infinity);
                      }

                      // else if(index >= controller.imageFiles.value.length-1){
                      //   return ShimmerLoadingWidget(height: double.infinity, width: double.infinity);
                      // }
                    } else {
                      return GestureDetector(
                ...
                itemCount: controller.loadingPickedImages.isTrue ? widget.lenghtList :  controller.imageFiles.length,
              )
          //         :
          // GridView.builder(
          // physics: BouncingScrollPhysics(
          ...
          //   );
          // },
          //   itemCount: widget.lenghtList,
          // ),
            ),
           widget.isEdit ? Container():Align(
              // bottom: 25.h,
            ...
            Visibility(
              visible: controller.selectedImageFiles.isNotEmpty &&
                  controller.imageFiles.isNotEmpty &&
                  controller.isAllowSelect.value,
              child: Align(
                // bottom: 25.h,
                alignment: AlignmentDirectional.bottomEnd,
                        ...
                        Expanded(
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              controller.imageFiles.removeWhere((item) =>
                                  controller.selectedImageFiles.contains(item));
                              CreateChaletGetxController
                                  .to.isAllowSelect.value = false;
                              CreateChaletGetxController.to.selectedImageFiles
                                  .clear();
                        ...
                        Visibility(
                          ...
                          child: Expanded(
                            child: IconButton(
                              ...
                              onPressed: () {
                                _pickImage(
                                    index: controller.imageFiles.indexOf(
                                        controller.selectedImageFiles[0]));
                              },
                            ),
                          ),
                        ),
  ...
  void _performUpload() {
    if (_checkDate()) {
      print(
          'image 1: ${CreateChaletGetxController.to.imageFiles[0].path} image2: ${CreateChaletGetxController.to.imageFiles[1].path}');
      Get.to(() => PricesScreen(
            isAdmin: true,
            isAdd: true,
  ...
  bool _checkDate() {
    if (CreateChaletGetxController.to.imageFiles.isNotEmpty) {
      return true;
    }
    showSnackBarByGet(
  ...
  void _upload() {
    // Get.to(ViewPicturesScreen());
  }

  void GoViewOicturesScreen() {
    Get.to(() => ViewPicturesForAdminScreen(
          firstIndex: 0,
          imagesChalet: CreateChaletGetxController.to.imageFiles.value,
        ));
  }
  ...
  void _editImages() async {
    if(_checkDate()){
      ...
      ApiResponse result = await AdminChaletsApiController().edaitImagesChalet(chaletId: AdminChaletsGetxController.to.chaletForManage.value.id,imageFiles:CreateChaletGetxController.to.imageFiles);
      if(result.success){
        CreateChaletGetxController.to.imageFiles.clear();
