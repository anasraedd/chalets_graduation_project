...
class _CouponScreenState extends State<CouponScreen>  with Helpers {
  @override
  void initState() {
    // TODO: implement initState
    Get.lazyPut<AdminChaletsGetxController>(() => AdminChaletsGetxController());
    //if (!UserGetxController.to.isGetFavoriteChalets.value) {
    AdminChaletsGetxController.to.getPriceDiscountCodes(id: AdminChaletsGetxController.to.chaletForManage.value.id);
    //}
    super.initState();
  }
  @override
      ...
      body: SafeArea(
          child: GetX<AdminChaletsGetxController>(
              ...
              builder: (AdminChaletsGetxController controller) {
                if(controller.loadedGetCopoun.isTrue){
                  ...
                  return
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              onTap: (){
                                controller.expiredCouponSelected.value = false;
                              },
                              child: CustomCategoriesTab(
                                title: 'Active Coupons',
                                isSelected: !controller.expiredCouponSelected.value,
                              ),
                            ),
                          ),
                          SizedBox(
                          ...
                          Expanded(child: GestureDetector(
                              onTap: (){
                                controller.expiredCouponSelected.value = true;
                              },
                              child: CustomCategoriesTab(title: 'Expired Coupons', isSelected: controller.expiredCouponSelected.value,))),
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: controller.expiredCouponSelected.value ? GridView.builder(
                          ...
                          itemCount: controller.chaletPriceExpiredDiscountCodes.value.length,
                        ): GridView.builder(
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                              crossAxisCount:2,
                              mainAxisSpacing: 15,
                          ...
                          itemCount: controller.chaletPriceActiveDiscountCodes.value.length,
                        ),
                      ),
                    )
                  ]);
        ...
        child: Stack(
          ...
          children: [
            SizedBox(
                height: 70.w,
                width: 70.w,
                child: SvgPicture.asset('assets/images/coupon_add.svg')),
            SizedBox(
                height: 70.w,
                width: 70.w,
